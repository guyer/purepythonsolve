...
### This function is for input for SageMathCell server in this form:
### >>> sage_inputs_01 = namestr( a=sage_output_01[0] , b=sage_output_01[1] , c=sage_output_01[2] )
### >>> sage_output_02= execute_sage_script_w_inputs(sage_inputs_01, filename)
def namestr(**kwargs):
  output = ""
